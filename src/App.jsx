...
import AllPlaylists from './components/pages/AllPlaylists'; // Add this import
  ...
  const MainLayout = ({ children }) => {
    ...
    const handleNavigation = (destination) => {
      switch (destination) {
        ...
        // case 'allPlaylists': navigate('/all-playlists'); break; // Add this line
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/forgot-password" element={!isAuthenticated ? <ForgotPasswordForm /> : <Navigate to="/" />} />
            ...
            isAuthenticated ? (
              <MainLayout>
                <Routes>
                  ...
                  <Route path="/all-playlists" element={<AllPlaylists />} /> Add this route
